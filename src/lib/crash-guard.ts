...
import { appendCrashLogEntry } from "./bounded-log";
...
// Re-export bounded-retention helpers so existing callers/tests importing from
// crash-guard keep working. The implementation now lives in ./bounded-log.
export { appendCrashLogEntry } from "./bounded-log";
export { CRASH_LOG_MAX_BYTES, CRASH_LOG_BACKUP_COUNT } from "./bounded-log";
export type { CrashLogRetentionOptions } from "./bounded-log";
