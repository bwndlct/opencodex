...
export const en = {
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "settings.routing.dualUnavailable": "Dual upstream is unavailable until a personal OpenAI provider and a company passthrough provider are configured.",
  "settings.routing.noCompanyProvider": "No eligible company provider",
  "settings.routing.openai.title": "OpenAI upstreams",
  "settings.routing.openai.subtitle": "Choose how bare OpenAI models move between the personal account pool and the company endpoint.",
  "settings.routing.openai.enabled": "Enable dual upstream",
  "settings.routing.openai.unavailable": "Configure the canonical personal OpenAI provider and a separate company passthrough provider before enabling this policy.",
  "settings.routing.openai.companyProvider": "Company provider",
  "settings.routing.openai.companyProviderHint": "Only openai-responses passthrough providers are eligible.",
  ...
  "settings.routing.openai.personalFirst": "Personal first",
  "settings.routing.openai.companyFirst": "Company first",
  "settings.routing.openai.autoSwitch": "Remember company fallback",
  "settings.routing.openai.autoSwitchHint": "Persist company-first after all personal accounts fail before output starts.",
