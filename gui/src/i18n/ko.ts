...
export const ko: Record<TKey, string> = {
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "sessions.col.execution": "실행 세션",
  "sessions.col.route": "경로",
  "sessions.col.upstream": "업스트림",
  "sessions.col.status": "상태",
  ...
  "sessions.policy.inherit": "상속",
  "sessions.policy.personalFirst": "개인 우선",
