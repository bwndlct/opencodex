...
export const de = {
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "settings.routing.dualUnavailable": "Dual-Upstream ist erst verfügbar, wenn ein persönlicher OpenAI-Provider und ein Company-Passthrough-Provider eingerichtet sind.",
  "settings.routing.noCompanyProvider": "Kein geeigneter Company-Provider",
  "settings.routing.openai.title": "OpenAI-Upstreams",
  "settings.routing.openai.subtitle": "Legt fest, wie einfache OpenAI-Modelle zwischen persönlichem Kontenpool und Company-Endpunkt wechseln.",
  "settings.routing.openai.enabled": "Dual-Upstream aktivieren",
  "settings.routing.openai.unavailable": "Vor der Aktivierung den persönlichen OpenAI-Provider und einen separaten Company-Passthrough-Provider einrichten.",
  "settings.routing.openai.companyProvider": "Company-Provider",
  "settings.routing.openai.companyProviderHint": "Nur openai-responses-Passthrough-Provider sind zulässig.",
  ...
  "settings.routing.openai.personalFirst": "Persönlich zuerst",
  "settings.routing.openai.companyFirst": "Company zuerst",
  "settings.routing.openai.autoSwitch": "Company-Fallback merken",
  "settings.routing.openai.autoSwitchHint": "Nach dem Ausfall aller persönlichen Konten vor dem ersten Byte Company zuerst speichern.",
