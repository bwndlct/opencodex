...
export const ko: Record<TKey, string> = {
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "settings.routing.dualUnavailable": "개인 OpenAI 프로바이더와 회사 passthrough 프로바이더를 구성해야 이중 상위 경로를 사용할 수 있습니다.",
  "settings.routing.noCompanyProvider": "사용 가능한 회사 프로바이더가 없음",
  "settings.routing.openai.title": "OpenAI 상위 경로",
  "settings.routing.openai.subtitle": "일반 OpenAI 모델이 개인 계정 풀과 회사 엔드포인트 사이에서 이동하는 방식을 선택합니다.",
  "settings.routing.openai.enabled": "이중 상위 경로 사용",
  "settings.routing.openai.unavailable": "사용 전에 표준 개인 OpenAI 프로바이더와 별도의 회사 passthrough 프로바이더를 구성하세요.",
  "settings.routing.openai.companyProvider": "회사 프로바이더",
  "settings.routing.openai.companyProviderHint": "openai-responses passthrough 프로바이더만 사용할 수 있습니다.",
  ...
  "settings.routing.openai.personalFirst": "개인 우선",
  "settings.routing.openai.companyFirst": "회사 우선",
  "settings.routing.openai.autoSwitch": "회사 대체 경로 기억",
  "settings.routing.openai.autoSwitchHint": "첫 바이트 전에 모든 개인 계정이 실패하면 회사 우선을 저장합니다.",
