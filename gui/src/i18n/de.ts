...
export const de = {
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "sessions.col.execution": "Execution-Session",
  "sessions.col.route": "Route",
  "sessions.col.upstream": "Upstream",
  ...
  "sessions.policy.inherit": "Übernehmen",
  "sessions.policy.personalFirst": "Persönlich zuerst",
