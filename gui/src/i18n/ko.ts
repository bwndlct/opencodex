...
export const ko: Record<TKey, string> = {
  ...
  "dash.visionModelHint": "사용 가능한 비전 프로바이더를 사용하며, 기본값은 ChatGPT 로그인을 사용합니다.",
  "dash.webSearchSidecar": "웹 검색 사이드카",
  "dash.webSearchSidecarHint": "라우팅 모델의 웹 검색에 쓸 백엔드와 모델을 고릅니다.",
  "dash.visionSidecar": "비전 사이드카",
  "dash.visionSidecarHint": "텍스트 전용 라우팅 모델이 이미지를 읽을 때 사용할 백엔드, 프로바이더와 모델을 고릅니다.",
  ...
  "dash.sidecarProvider": "프로바이더",
  "dash.sidecarProviderDefault": "기본",
  "dash.backendAuto": "자동",
  ...
  "models.v2ThreadsDefault": "기본값 (16)",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "mro.tab.overrides": "네이티브 모델 교체",
  "mro.tab.combos": "콤보 및 장애 조치",
  "mro.loading": "모델 라우트 오버라이드 로딩 중…",
  "mro.loadFailed": "모델 라우트 오버라이드를 로드할 수 없습니다.",
  "mro.saveFailed": "모델 라우트 오버라이드를 저장할 수 없습니다.",
  "mro.saved": "모델 라우트 오버라이드가 저장되었습니다.",
  "mro.globalEnabled": "모델 라우트 오버라이드 활성화",
  "mro.emptyRules": "구성된 오버라이드 규칙이 없습니다. \"규칙 추가\"를 클릭하여 생성하세요.",
  "mro.source": "소스 모델",
  "mro.target": "대상",
  "mro.effort": "추론 강도",
  "mro.effortInherit": "상속",
  "mro.pickSource": "소스 선택…",
  "mro.pickTarget": "대상 선택…",
  "mro.addRule": "규칙 추가",
  "mro.miniWarning": "gpt-5.4-mini는 백그라운드 도우미 호출(제목, 커밋)에 사용됩니다. 이를 재정의하면 지연 시간이나 비용이 증가할 수 있습니다.",

  "sessions.title": "세션",
  "sessions.refresh": "세션 새로고침",
  "sessions.loading": "세션 불러오는 중…",
  "sessions.loadError": "세션 데이터를 새로고치지 못했습니다. 마지막 스냅샷을 표시합니다.",
  ...
  "sessions.source.other": "기타 {count}",
  "sessions.main": "메인",
  "sessions.child": "하위",
  "sessions.started": "실행 시간",
  "sessions.lastSeen": "마지막 활동",
  "sessions.age.seconds": "{count}초",
  "sessions.age.minutes": "{count}분",
  "sessions.age.hours": "{count}시간",
  "sessions.requested": "요청",
  "sessions.effective": "실제",
  "sessions.noRoute": "경로 대기 중",
  "sessions.upstream.codexPool": "Codex 풀",
  "sessions.upstream.codexDirect": "Codex 직접",
  "sessions.upstream.provider": "프로바이더",
  "sessions.upstream.none": "대기 중",
  "sessions.status.recent": "완료",
  "sessions.policy.aria": "세션 라우팅 정책",
  "sessions.policy.inherit": "글로벌 상속",
  "sessions.policy.personalFirst": "계정 우선",
  "sessions.policy.companyFirst": "API Key 우선",
  "sessions.policy.updateError": "정책 업데이트에 실패했습니다.",
  "sessions.policy.lockedTitle": "라우팅 정책 컨트롤이 잠겼습니다. 듀얼 GPT 라우팅을 사용할 수 없거나, legacy이거나 구성되지 않았습니다.",
  "sessions.fallback.personalUnavailable": "계정 소스를 사용할 수 없음",
  "sessions.expandLogs": "로그 펼치기",
  "sessions.collapseLogs": "로그 접기",
  "sessions.tokens.partial": "토큰 데이터가 없는 요청 {count}개가 포함되어 있습니다.",
  "sessions.logs.title": "로그",
  "sessions.logs.loading": "로그 불러오는 중…",
  "sessions.logs.loadError": "로그를 불러오지 못했습니다.",
  "sessions.logs.empty": "로그가 없습니다.",
  "settings.navigation.title": "네비게이션",
  "settings.navigation.subtitle": "사이드바에 표시할 항목을 선택하세요.",
  "settings.navigation.show": "{item} 표시",
  "settings.routing.eyebrow": "런타임 정책",
  "settings.routing.title": "라우팅 설정",
  "settings.routing.subtitle": "새 요청의 상위 경로와 최대 추론 정책을 설정합니다.",
  "settings.routing.refresh": "설정 새로 고침",
  "settings.routing.loading": "설정을 불러오는 중…",
  "settings.routing.loadError": "설정을 불러오지 못했습니다.",
  "settings.routing.retry": "다시 시도",
  "settings.routing.saved": "설정이 저장되었습니다. 새 요청부터 업데이트된 정책을 사용합니다.",
  "settings.routing.saveError": "설정을 저장하지 못했습니다.",
  "settings.routing.save": "설정 저장",
  "settings.routing.saving": "저장 중…",
  "settings.routing.applies": "변경 사항은 새 요청에 적용됩니다.",
  "settings.routing.modelListRequired": "모델 ID를 하나 이상 추가하거나 이 정책을 끄세요.",
  "settings.routing.dualUnavailable": "계정과 준비된 API Key 프로바이더를 구성해야 듀얼 소스를 사용할 수 있습니다.",
  "settings.routing.noCompanyProvider": "사용 가능한 API Key 프로바이더가 없음",
  "settings.routing.openai.title": "OpenAI 소스",
  "settings.routing.openai.subtitle": "일반 OpenAI 모델이 계정과 API Key 소스 사이에서 이동하는 방식을 선택합니다.",
  "settings.routing.openai.enabled": "듀얼 소스 사용",
  "settings.routing.openai.unavailable": "사용 전에 계정과 준비된 API Key 프로바이더를 구성하세요.",
  "settings.routing.openai.companyProvider": "API Key 소스",
  "settings.routing.openai.companyProviderHint": "준비된 API Key 프로바이더만 사용 가능합니다.",
  "settings.routing.openai.legacyProvider": "legacy passthrough",
  "settings.routing.openai.legacyNotice": "이 프로바이더는 legacy 호출자 자격 증명 passthrough이며 실제 API Key가 아닙니다. 그대로 유지하거나, 듀얼 소스를 끄거나, 준비된 API Key 프로바이더로 전환하세요.",
  "settings.routing.openai.sourceUnavailable": "선택한 API Key 소스를 사용할 수 없습니다. 소스를 복원하거나 다른 프로바이더를 선택하거나 듀얼 소스를 끄세요.",
  "settings.routing.openai.defaultPolicy": "기본 순서",
  "settings.routing.openai.defaultPolicyHint": "Sessions 페이지에서 개별 세션이 이 선택을 덮어쓸 수 있습니다.",
  "settings.routing.openai.personalFirst": "계정 우선",
  "settings.routing.openai.companyFirst": "API Key 우선",
  "settings.routing.reasoning.title": "최대 추론",
  "settings.routing.reasoning.subtitle": "일치하는 모델 ID는 지원되는 가장 높은 추론 단계를 사용합니다.",
  "settings.routing.reasoning.luna": "Luna 모델",
  "settings.routing.reasoning.lunaHint": "일반 Luna 턴은 max를 사용하고 memory와 명시적 low는 유지합니다.",
  "settings.routing.reasoning.lunaModels": "Luna 모델 ID",
  "settings.routing.reasoning.glm": "GLM 모델",
  "settings.routing.reasoning.glmHint": "일치하는 모든 GLM 요청은 memory와 명시적 low를 포함해 max를 사용합니다.",
  "settings.routing.reasoning.glmModels": "GLM 모델 ID",
};
