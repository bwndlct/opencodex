...
export const en = {
  ...
  "dash.visionModelHint": "Uses the selected vision provider when available; the default uses your ChatGPT login.",
  ...
  "dash.visionSidecarHint": "Choose the backend, provider, and model used to describe images for text-only routed models.",
  ...
  "dash.sidecarProvider": "Provider",
  "dash.sidecarProviderDefault": "Default",
  ...
  "models.v2ThreadsDefault": "default (16)",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "mro.tab.overrides": "Native Model Replacement",
  "mro.tab.combos": "Combos & Failover",
  "mro.loading": "Loading model route overrides…",
  "mro.loadFailed": "Could not load model route overrides.",
  "mro.saveFailed": "Could not save model route overrides.",
  "mro.saved": "Model route overrides saved.",
  "mro.globalEnabled": "Enable model route overrides",
  "mro.emptyRules": "No override rules configured. Click \"Add rule\" to create one.",
  "mro.source": "Source model",
  "mro.target": "Target",
  "mro.effort": "Effort",
  "mro.effortInherit": "Inherit",
  "mro.pickSource": "Select source…",
  "mro.pickTarget": "Select target…",
  "mro.addRule": "Add rule",
  "mro.miniWarning": "gpt-5.4-mini is used for background helper calls (titles, commits). Overriding it may increase latency or cost.",

  // sessions
  "sessions.title": "Sessions",
  "sessions.refresh": "Refresh Sessions",
  "sessions.loading": "Loading Sessions…",
  "sessions.loadError": "Session data could not be refreshed. Showing the last available snapshot.",
  ...
  "sessions.source.other": "{count}Other",
  "sessions.main": "Main",
  "sessions.child": "Child",
  "sessions.started": "Running",
  "sessions.lastSeen": "Last seen",
  "sessions.age.seconds": "{count}s",
  "sessions.age.minutes": "{count}m",
  "sessions.age.hours": "{count}h",
  "sessions.requested": "Requested",
  "sessions.effective": "Effective",
  "sessions.noRoute": "Route pending",
  "sessions.upstream.codexPool": "Codex pool",
  "sessions.upstream.codexDirect": "Codex direct",
  "sessions.upstream.provider": "Provider",
  "sessions.upstream.none": "Pending",
  "sessions.status.recent": "Completed",
  "sessions.policy.aria": "Session route policy",
  "sessions.policy.inherit": "Inherit global",
  "sessions.policy.personalFirst": "Account first",
  "sessions.policy.companyFirst": "API Key first",
  "sessions.policy.updateError": "Policy update failed.",
  "sessions.policy.lockedTitle": "Route-policy controls are locked. Dual GPT routing is unavailable, legacy, or not configured.",
  "sessions.fallback.personalUnavailable": "Account source unavailable",
  "sessions.expandLogs": "Show logs",
  "sessions.collapseLogs": "Hide logs",
  "sessions.tokens.partial": "Includes {count} requests without token data.",
  "sessions.logs.title": "Logs",
  "sessions.logs.loading": "Loading logs…",
  "sessions.logs.loadError": "Logs could not be loaded.",
  "sessions.logs.empty": "No logs yet.",
  "settings.navigation.title": "Navigation",
  "settings.navigation.subtitle": "Choose which items appear in the sidebar.",
  "settings.navigation.show": "Show {item}",
  "settings.routing.eyebrow": "Runtime policy",
  "settings.routing.title": "Routing settings",
  "settings.routing.subtitle": "Control upstream selection and maximum reasoning policies for new requests.",
  "settings.routing.refresh": "Refresh settings",
  "settings.routing.loading": "Loading settings…",
  "settings.routing.loadError": "Settings could not be loaded.",
  "settings.routing.retry": "Try again",
  "settings.routing.saved": "Settings saved. New requests use the updated policy.",
  "settings.routing.saveError": "Settings could not be saved.",
  "settings.routing.save": "Save settings",
  "settings.routing.saving": "Saving…",
  "settings.routing.applies": "Changes apply to new requests.",
  "settings.routing.modelListRequired": "Add at least one model id or turn this policy off.",
  "settings.routing.dualUnavailable": "Dual source is unavailable until an account and a ready API key provider are configured.",
  "settings.routing.noCompanyProvider": "No eligible API key provider",
  "settings.routing.openai.title": "OpenAI sources",
  "settings.routing.openai.subtitle": "Choose how bare OpenAI models move between your account and an API key source.",
  "settings.routing.openai.enabled": "Enable dual source",
  "settings.routing.openai.unavailable": "Configure an account and a ready API key provider before enabling this source.",
  "settings.routing.openai.companyProvider": "API Key source",
  "settings.routing.openai.companyProviderHint": "Ready API key providers only.",
  "settings.routing.openai.legacyProvider": "legacy passthrough",
  "settings.routing.openai.legacyNotice": "This provider is a legacy caller-credential passthrough, not a real API key. Keep it, disable dual source, or switch to a ready API key provider.",
  "settings.routing.openai.sourceUnavailable": "The selected API key source is unavailable. Restore it, choose another provider, or disable dual source.",
  "settings.routing.openai.defaultPolicy": "Default order",
  "settings.routing.openai.defaultPolicyHint": "A Session can override this choice from the Sessions page.",
  "settings.routing.openai.personalFirst": "Account first",
  "settings.routing.openai.companyFirst": "API Key first",
  "settings.routing.reasoning.title": "Maximum reasoning",
  "settings.routing.reasoning.subtitle": "Matching model ids are sent with the highest supported reasoning effort.",
  "settings.routing.reasoning.luna": "Luna models",
  "settings.routing.reasoning.lunaHint": "Ordinary Luna turns use max; memory and explicit low remain unchanged.",
  "settings.routing.reasoning.lunaModels": "Luna model ids",
  "settings.routing.reasoning.glm": "GLM models",
  "settings.routing.reasoning.glmHint": "Every matching GLM request uses max, including memory and explicit low.",
  "settings.routing.reasoning.glmModels": "GLM model ids",
} as const;
