...
export const zh: Record<TKey, string> = {
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "settings.routing.dualUnavailable": "请先配置标准个人 OpenAI 提供方和独立的公司 passthrough 提供方，才能启用双上游。",
  "settings.routing.noCompanyProvider": "没有符合条件的公司提供方",
  "settings.routing.openai.title": "OpenAI 上游",
  "settings.routing.openai.subtitle": "选择裸 OpenAI 模型在个人账号池和公司端点之间的调度方式。",
  "settings.routing.openai.enabled": "启用双上游",
  "settings.routing.openai.unavailable": "启用前请配置标准个人 OpenAI 提供方和独立的公司 passthrough 提供方。",
  "settings.routing.openai.companyProvider": "公司提供方",
  "settings.routing.openai.companyProviderHint": "只有 openai-responses passthrough 提供方可用。",
  "settings.routing.openai.defaultPolicy": "默认顺序",
  "settings.routing.openai.defaultPolicyHint": "可以在 Sessions 页面为单个 Session 覆盖此选择。",
  "settings.routing.openai.personalFirst": "个人优先",
  "settings.routing.openai.companyFirst": "公司优先",
  "settings.routing.openai.autoSwitch": "记住公司回退",
  "settings.routing.openai.autoSwitchHint": "所有个人账号在首字节前失败后，持久化为公司优先。",
