...
export const de = {
  ...
  "dash.visionModelHint": "Verwendet den ausgewählten Vision-Anbieter, sofern verfügbar; standardmäßig den ChatGPT-Login.",
  ...
  "dash.visionSidecarHint": "Backend, Anbieter und Modell zur Bildbeschreibung für reine Textmodelle auswählen.",
  ...
  "dash.sidecarProvider": "Anbieter",
  "dash.sidecarProviderDefault": "Standard",
  ...
  "models.v2ThreadsDefault": "Standard (16)",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "mro.tab.overrides": "Natives Modell ersetzen",
  "mro.tab.combos": "Combos & Failover",
  "mro.loading": "Modell-Routen-Overrides werden geladen…",
  "mro.loadFailed": "Modell-Routen-Overrides konnten nicht geladen werden.",
  "mro.saveFailed": "Modell-Routen-Overrides konnten nicht gespeichert werden.",
  "mro.saved": "Modell-Routen-Overrides gespeichert.",
  "mro.globalEnabled": "Modell-Routen-Overrides aktivieren",
  "mro.emptyRules": "Keine Override-Regeln konfiguriert. Klicken Sie auf \"Regel hinzufügen\", um eine zu erstellen.",
  "mro.source": "Quellmodell",
  "mro.target": "Ziel",
  "mro.effort": "Aufwand",
  "mro.effortInherit": "Vererben",
  "mro.pickSource": "Quelle wählen…",
  "mro.pickTarget": "Ziel wählen…",
  "mro.addRule": "Regel hinzufügen",
  "mro.miniWarning": "gpt-5.4-mini wird für Hintergrund-Hilfsaufrufe (Titel, Commits) verwendet. Eine Überschreibung kann Latenz oder Kosten erhöhen.",

  "sessions.title": "Sessions",
  "sessions.refresh": "Sessions aktualisieren",
  "sessions.loading": "Sessions werden geladen…",
  "sessions.loadError": "Session-Daten konnten nicht aktualisiert werden. Der letzte verfügbare Stand wird angezeigt.",
  ...
  "sessions.col.policy": "Richtlinie",
  "sessions.col.tokens": "Tokens gesamt",
  "sessions.activeRequests": "{count} aktiv",
  "sessions.source.gpt": "{count}GPT",
  "sessions.source.glm": "{count}GLM",
  "sessions.source.other": "{count}Andere",
  "sessions.main": "Main",
  "sessions.child": "Child",
  "sessions.started": "Läuft seit",
  "sessions.lastSeen": "Zuletzt gesehen",
  "sessions.age.seconds": "{count}s",
  "sessions.age.minutes": "{count}m",
  "sessions.age.hours": "{count}h",
  "sessions.requested": "Angefordert",
  "sessions.effective": "Effektiv",
  "sessions.noRoute": "Route ausstehend",
  "sessions.upstream.codexPool": "Codex-Pool",
  "sessions.upstream.codexDirect": "Codex direkt",
  "sessions.upstream.provider": "Anbieter",
  "sessions.upstream.none": "Ausstehend",
  "sessions.status.recent": "Abgeschlossen",
  "sessions.policy.aria": "Session-Routing-Richtlinie",
  "sessions.policy.inherit": "Global erben",
  "sessions.policy.personalFirst": "Konto zuerst",
  "sessions.policy.companyFirst": "API-Key zuerst",
  "sessions.policy.updateError": "Richtlinie konnte nicht aktualisiert werden.",
  "sessions.policy.lockedTitle": "Routing-Richtlinie-Kontrollen gesperrt. Duales GPT-Routing ist nicht verfügbar, legacy oder nicht konfiguriert.",
  "sessions.fallback.personalUnavailable": "Kontoquelle nicht verfügbar",
  "sessions.expandLogs": "Protokoll einblenden",
  "sessions.collapseLogs": "Protokoll ausblenden",
  "sessions.tokens.partial": "Enthält {count} Anfragen ohne Token-Daten.",
  "sessions.logs.title": "Protokoll",
  "sessions.logs.loading": "Protokoll wird geladen…",
  "sessions.logs.loadError": "Protokoll konnte nicht geladen werden.",
  "sessions.logs.empty": "Noch keine Protokolle.",
  "settings.navigation.title": "Navigation",
  "settings.navigation.subtitle": "Wählen Sie die in der Seitenleiste angezeigten Elemente.",
  "settings.navigation.show": "{item} anzeigen",
  "settings.routing.eyebrow": "Laufzeitrichtlinie",
  "settings.routing.title": "Routing-Einstellungen",
  "settings.routing.subtitle": "Steuert Upstream-Auswahl und maximale Reasoning-Richtlinien für neue Anfragen.",
  "settings.routing.refresh": "Einstellungen aktualisieren",
  "settings.routing.loading": "Einstellungen werden geladen…",
  "settings.routing.loadError": "Einstellungen konnten nicht geladen werden.",
  "settings.routing.retry": "Erneut versuchen",
  "settings.routing.saved": "Einstellungen gespeichert. Neue Anfragen verwenden die aktualisierte Richtlinie.",
  "settings.routing.saveError": "Einstellungen konnten nicht gespeichert werden.",
  "settings.routing.save": "Einstellungen speichern",
  "settings.routing.saving": "Wird gespeichert…",
  "settings.routing.applies": "Änderungen gelten für neue Anfragen.",
  "settings.routing.modelListRequired": "Mindestens eine Modell-ID hinzufügen oder diese Richtlinie deaktivieren.",
  "settings.routing.dualUnavailable": "Dual-Source ist erst verfügbar, wenn ein Konto und ein bereiter API-Key-Provider eingerichtet sind.",
  "settings.routing.noCompanyProvider": "Kein geeigneter API-Key-Provider",
  "settings.routing.openai.title": "OpenAI-Quellen",
  "settings.routing.openai.subtitle": "Legt fest, wie einfache OpenAI-Modelle zwischen Konto und API-Key-Quelle wechseln.",
  "settings.routing.openai.enabled": "Dual-Source aktivieren",
  "settings.routing.openai.unavailable": "Vor der Aktivierung ein Konto und einen bereiten API-Key-Provider einrichten.",
  "settings.routing.openai.companyProvider": "API-Key-Quelle",
  "settings.routing.openai.companyProviderHint": "Nur bereite API-Key-Provider sind zulässig.",
  "settings.routing.openai.legacyProvider": "Legacy-Passthrough",
  "settings.routing.openai.legacyNotice": "Dieser Provider ist ein Legacy-Aufrufer-Anmeldedaten-Passthrough, kein echter API-Key. Beibehalten, Dual-Source deaktivieren oder zu einem bereiten API-Key-Provider wechseln.",
  "settings.routing.openai.sourceUnavailable": "Die ausgewählte API-Key-Quelle ist nicht verfügbar. Quelle wiederherstellen, anderen Provider wählen oder Dual-Source deaktivieren.",
  "settings.routing.openai.defaultPolicy": "Standardreihenfolge",
  "settings.routing.openai.defaultPolicyHint": "Eine Session kann diese Auswahl auf der Sessions-Seite überschreiben.",
  "settings.routing.openai.personalFirst": "Konto zuerst",
  "settings.routing.openai.companyFirst": "API-Key zuerst",
  "settings.routing.reasoning.title": "Maximales Reasoning",
  "settings.routing.reasoning.subtitle": "Übereinstimmende Modell-IDs verwenden die höchste unterstützte Reasoning-Stufe.",
  "settings.routing.reasoning.luna": "Luna-Modelle",
  "settings.routing.reasoning.lunaHint": "Normale Luna-Turns verwenden max; Memory und explizites low bleiben unverändert.",
  "settings.routing.reasoning.lunaModels": "Luna-Modell-IDs",
  "settings.routing.reasoning.glm": "GLM-Modelle",
  "settings.routing.reasoning.glmHint": "Jede passende GLM-Anfrage verwendet max, auch Memory und explizites low.",
  "settings.routing.reasoning.glmModels": "GLM-Modell-IDs",
} as const;
