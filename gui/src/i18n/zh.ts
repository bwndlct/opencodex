...
export const zh: Record<TKey, string> = {
  ...
  "dash.visionModelHint": "有可用的视觉提供商时使用所选提供商；默认使用 ChatGPT 登录。",
  "dash.webSearchSidecar": "网页搜索附属服务",
  "dash.webSearchSidecarHint": "选择路由模型进行网页搜索时使用的后端和模型。",
  "dash.visionSidecar": "视觉附属服务",
  "dash.visionSidecarHint": "选择纯文本路由模型描述图像时使用的后端、提供商和模型。",
  ...
  "dash.sidecarProvider": "提供商",
  "dash.sidecarProviderDefault": "默认",
  "dash.backendAuto": "自动",
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "mro.tab.overrides": "原生模型替换",
  "mro.tab.combos": "组合与故障转移",
  "mro.loading": "正在加载模型路由覆盖…",
  "mro.loadFailed": "无法加载模型路由覆盖。",
  "mro.saveFailed": "无法保存模型路由覆盖。",
  "mro.saved": "模型路由覆盖已保存。",
  "mro.globalEnabled": "启用模型路由覆盖",
  "mro.emptyRules": "未配置覆盖规则。点击\"添加规则\"创建。",
  "mro.source": "源模型",
  "mro.target": "目标",
  "mro.effort": "推理强度",
  "mro.effortInherit": "继承",
  "mro.pickSource": "选择源…",
  "mro.pickTarget": "选择目标…",
  "mro.addRule": "添加规则",
  "mro.miniWarning": "gpt-5.4-mini 用于后台辅助调用（标题、提交信息）。覆盖它可能增加延迟或成本。",

  "sessions.title": "Session",
  "sessions.refresh": "刷新 Session",
  "sessions.loading": "正在加载 Session…",
  "sessions.loadError": "Session 数据刷新失败，当前显示最近一次可用快照。",
  ...
  "sessions.source.other": "{count}其他",
  "sessions.main": "主",
  "sessions.child": "子",
  "sessions.started": "已运行",
  "sessions.lastSeen": "最后活动",
  "sessions.age.seconds": "{count} 秒",
  "sessions.age.minutes": "{count} 分钟",
  "sessions.age.hours": "{count} 小时",
  "sessions.requested": "请求",
  "sessions.effective": "实际",
  "sessions.noRoute": "路由解析中",
  "sessions.upstream.codexPool": "Codex 账号池",
  "sessions.upstream.codexDirect": "Codex 直连",
  "sessions.upstream.provider": "提供方",
  "sessions.upstream.none": "等待中",
  "sessions.status.recent": "已完成",
  "sessions.policy.aria": "Session 路由策略",
  "sessions.policy.inherit": "继承全局",
  "sessions.policy.personalFirst": "账号优先",
  "sessions.policy.companyFirst": "API Key 优先",
  "sessions.policy.updateError": "策略更新失败。",
  "sessions.policy.lockedTitle": "路由策略控件已锁定。双 GPT 路由不可用、为 legacy 或未配置。",
  "sessions.fallback.personalUnavailable": "账号来源当前不可用",
  "sessions.expandLogs": "展开日志",
  "sessions.collapseLogs": "收起日志",
  "sessions.tokens.partial": "其中 {count} 个请求没有 Token 数据。",
  "sessions.logs.title": "日志",
  "sessions.logs.loading": "正在加载日志…",
  "sessions.logs.loadError": "日志加载失败。",
  "sessions.logs.empty": "暂无日志。",
  "settings.navigation.title": "导航",
  "settings.navigation.subtitle": "选择侧边栏中显示的项目。",
  "settings.navigation.show": "显示{item}",
  "settings.routing.eyebrow": "运行策略",
  "settings.routing.title": "路由设置",
  "settings.routing.subtitle": "控制新请求的上游选择和最高推理策略。",
  "settings.routing.refresh": "刷新设置",
  "settings.routing.loading": "正在加载设置…",
  "settings.routing.loadError": "设置加载失败。",
  "settings.routing.retry": "重试",
  "settings.routing.saved": "设置已保存，新请求将使用更新后的策略。",
  "settings.routing.saveError": "设置保存失败。",
  "settings.routing.save": "保存设置",
  "settings.routing.saving": "保存中…",
  "settings.routing.applies": "更改仅应用于后续请求。",
  "settings.routing.modelListRequired": "至少添加一个模型 ID，或关闭此策略。",
  "settings.routing.dualUnavailable": "请先配置账号和一个就绪的 API Key 提供方，才能启用双来源。",
  "settings.routing.noCompanyProvider": "没有符合条件的 API Key 提供方",
  "settings.routing.openai.title": "OpenAI 来源",
  "settings.routing.openai.subtitle": "选择裸 OpenAI 模型在账号和 API Key 来源之间的调度方式。",
  "settings.routing.openai.enabled": "启用双来源",
  "settings.routing.openai.unavailable": "启用前请配置账号和一个就绪的 API Key 提供方。",
  "settings.routing.openai.companyProvider": "API Key 来源",
  "settings.routing.openai.companyProviderHint": "仅限就绪的 API Key 提供方。",
  "settings.routing.openai.legacyProvider": "legacy 透传",
  "settings.routing.openai.legacyNotice": "该提供方是 legacy 调用方凭据透传，并非真正的 API Key。可保留、关闭双来源，或切换到就绪的 API Key 提供方。",
  "settings.routing.openai.sourceUnavailable": "所选 API Key 来源不可用。请恢复该来源、选择其他提供方或关闭双来源。",
  "settings.routing.openai.defaultPolicy": "默认顺序",
  "settings.routing.openai.defaultPolicyHint": "可以在 Sessions 页面为单个 Session 覆盖此选择。",
  "settings.routing.openai.personalFirst": "账号优先",
  "settings.routing.openai.companyFirst": "API Key 优先",
  "settings.routing.reasoning.title": "最高推理",
  "settings.routing.reasoning.subtitle": "匹配的模型 ID 会使用支持的最高推理程度。",
  "settings.routing.reasoning.luna": "Luna 模型",
  "settings.routing.reasoning.lunaHint": "普通 Luna 请求使用 max；memory 和显式 low 保持不变。",
  "settings.routing.reasoning.lunaModels": "Luna 模型 ID",
  "settings.routing.reasoning.glm": "GLM 模型",
  "settings.routing.reasoning.glmHint": "所有匹配的 GLM 请求使用 max，包括 memory 和显式 low。",
  "settings.routing.reasoning.glmModels": "GLM 模型 ID",
};
